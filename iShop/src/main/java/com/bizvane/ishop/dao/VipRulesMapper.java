...
public interface VipRulesMapper {
    ...
    VipRules selectByVipType(@Param("corp_code") String corp_code,@Param("vip_type") String vip_type,@Param("high_vip_type") String high_vip_type,@Param("isactive") String isactive)throws SQLException;
