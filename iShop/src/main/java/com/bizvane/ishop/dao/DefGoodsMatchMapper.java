...
public interface DefGoodsMatchMapper {
    List<DefGoodsMatch> selectMatchGoods(@Param("corp_code")String corp_code)throws Exception;

    List<DefGoodsMatch> selMatchBySeach(@Param("corp_code")String corp_code,@Param("search_value")String search_value)throws Exception;
