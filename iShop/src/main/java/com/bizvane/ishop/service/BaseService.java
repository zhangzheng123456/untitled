...
public interface BaseService {
    ...
    void insertUserOperation(String operation_corp_code,String operation_user_code,String function,String action,String corp_code, String code,String name)throws Exception;
}
