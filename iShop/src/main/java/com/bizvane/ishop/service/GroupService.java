...
public interface GroupService {
    ...
    PageInfo<Group> getGroupAll(int page_number, int page_size, String corp_code, String role_code, String search_value,String manager_corp) throws Exception;
    ...
    PageInfo<Group> getAllGroupScreen(int page_number, int page_size, String corp_code, String role_code, Map<String,String> map,String manager_corp) throws Exception;
    ...
    int insert(VipActivity vipActivity) throws Exception;

    int insertDetail(VipActivityDetail detail) throws Exception;

    int insertDetailAnniversary(VipActivityDetailAnniversary detailAnniversary) throws Exception;

    int updateDetail(VipActivityDetail detail) throws Exception;
}
