...
public class OutCsvHelper {
    ...
    public static String OutExecl(String json, List olist, LinkedHashMap<String, String> cols, HttpServletResponse response, HttpServletRequest request, String fileName) {
        ...
        try {
            ...
            String filename = fileName + "_" + corp_code + user_id + "_" + sdf.format(new Date()) + ".csv";
            ...
            System.out.println("CSV===util：" + path + "/" + filename);
            write(path + "/" + filename, values, lists);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            if (book != null) {
    ...
    public static void write(String filePath, List<String> headers, List<List<String>> content) {
        try {
            ...
            String[] headers_array = (String[]) headers.toArray(new String[headers.size()]);
            csvWriter.writeRecord(headers_array);
            // 写表头
            for (List<String> content_array_1 : content) {
                String[] headers_array_2 = (String[]) content_array_1.toArray(new String[content_array_1.size()]);
                csvWriter.writeRecord(headers_array_2);
            }
    ...
    public static String OutExecl_vip2(JSONArray array, LinkedHashMap<String, String> cols, HttpServletRequest request, String fileName) {
        String result = "";
        WritableWorkbook book = null;
        Set<String> keys = cols.keySet();
        try {
...
//判断目录是否存在
    ...
    public static void read() {
        ...
        String filePath = "E:\\QQ生成文档\\331393451\\FileRecv\\file_error.csv";
    ...
    public static String read_csv(String file_path) {
        String line = "";
        String everyLine = "";
        File csv = new File(file_path);  // CSV文件路径
        ...
        try {
            ...
            {
                everyLine = line;
                System.out.println(everyLine.split(",").length);
