...
//            this.vipRecordService.insert(vipCallbackRecord);
//            dataBean.setId(id);
...
//
//            VipCallbackRecord vipCallbackRecord = this.vipRecordService.getVipCallbackRecord(vipCallbackRecord_id);
...
//            vipCallbackRecord.setModifier(user_id);
//            this.vipRecordService.update(vipCallbackRecord);
//            dataBean.setId(id);
//            dataBean.setCode(Common.DATABEAN_CODE_SUCCESS);
//            dataBean.setMessage("edit success!!!s");
//        } catch (Exception ex) {
