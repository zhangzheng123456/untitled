...
var buy={
    ...
    renderPage:function(list){
        ...
        for(var i=0;i<list.length;i++){
           html+="<div class='parent' data-ids=''><div class='checkbox'><input type='checkbox' value='' name='test'  class='check'><label></label></div><div class='shop'><div class='img'><img src='"
               +list[i].image_url+"' alt=''></div><div class='shop-t'><p>"
               +list[i].name+"</p><div class='select'>选择规格</div></div><div class='shop_num'>" +
