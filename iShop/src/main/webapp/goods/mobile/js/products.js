        ...
        if(type=="share"){
            for(var i=0;i<goods_image.length;i++){
                if(goods_image[i].image.indexOf("http")!==-1&&goods_image[i].is_public=="Y"){
                    jQuery('.header .swiper-wrapper').append('<div class="swiper-slide"><span class="item"></span><img src="' + goods_image[i].image+ '@500h_500w_1e_1c" data-preview-src="'+goods_image[i].image+'" data-preview-group="image"></div>');
                }
            }
            jQuery('#buy').html("详情");
