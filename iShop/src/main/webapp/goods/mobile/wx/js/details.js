            ...
            for(var i=0;i<imgArr.length;i++){
                ...
                (function(img){
                    getSize(img,function(wdh,hgt,top,left){
                        LEN++;
                        var tempHTML = '<div  class="swiper-slide""> <img  style=" margin-top:'+top+'px;margin-left:'+left+'px;width:'+wdh+'px;height:'+hgt+'px" src="${img}" alt="" data-preview-src="" data-preview-group="1"> </div>';
                        var nowHTML = tempHTML;
                        nowHTML = nowHTML.replace('${img}',img);
                        HTMLVlaue+=nowHTML;
                        console.log(wdh,hgt,top,left);
...
$('.editor').click(function () {
    ...
    param["url"]="http://"+host+"/goods/mobile_v2/add_new.html?d_match_code=" + d_match_code +"&corp_code=" + corp_code+"&user_id="+user_code;
    console.log(param);
...
function toReturnShareInfo(){
    ...
    param["share_url"]="http://"+host+"/goods/mobile_v2/details_share.html?d_match_code=" + d_match_code +"&corp_code=" + corp_code+"&user_id="+user_code;
    var param=JSON.stringify(param);
    var osType = getWebOSType();
    if(osType=="iOS"){
        try{
