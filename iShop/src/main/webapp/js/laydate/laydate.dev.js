...
Dates.timeVoid = function(times, index){
    if(Dates.ymd[1]+1 == Dates.mins[1] && Dates.ymd[2] == Dates.mins[2]){
        if(index === 0 && (times < Dates.mins[3])){
            return 1;
        } else if(index === 1 && times < Dates.mins[4] && Dates.mins[3] == Dates.hmsin[0].value){
            return 1;
        } else if(index === 2 && times < Dates.mins[5] && Dates.mins[3] == Dates.hmsin[0].value && Dates.mins[4] == Dates.hmsin[1].value){
            return 1;
        }
