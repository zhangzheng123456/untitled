...
var provinceList = [
{name:'省份',cityList:[{name:'城市',areaList:['区县']}]},
{name:'北京', cityList:[		   
...
{name:'台湾', cityList:[
{name:'台北', areaList:['市、县级市']},
{name:'高雄', areaList:['市、县级市']},
{name:'台中', areaList:['市、县级市']},
{name:'花莲', areaList:['市、县级市']},
{name:'基隆', areaList:['市、县级市']},
{name:'嘉义', areaList:['市、县级市']},
{name:'金门', areaList:['市、县级市']},
{name:'连江', areaList:['市、县级市']},
{name:'苗栗', areaList:['市、县级市']},
{name:'南投', areaList:['市、县级市']},
{name:'澎湖', areaList:['市、县级市']},
{name:'屏东', areaList:['市、县级市']},
{name:'台东', areaList:['市、县级市']},
{name:'台南', areaList:['市、县级市']},
{name:'桃园', areaList:['市、县级市']},
{name:'新竹', areaList:['市、县级市']},
{name:'宜兰', areaList:['市、县级市']},
{name:'云林', areaList:['市、县级市']},
{name:'彰化', areaList:['市、县级市']}
]},
{name:'香港', cityList:[
{name:'香港特别行政区', areaList:["中西区","东区","九龙城区","观塘区","南区","深水埗区","湾仔区","黄大仙区","油尖旺区","离岛区","葵青区","北区","西贡区","沙田区","屯门区","大埔区","荃湾区","元朗区"]},
]},
{name:'澳门', cityList:[
{name:'澳门特别行政区', areaList:['澳门特别行政区']}
]}
];