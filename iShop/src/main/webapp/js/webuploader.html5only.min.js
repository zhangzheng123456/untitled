				        ...
				        if($("#GOODS_CODE").val()!==''){
				        	if(init_length<20&&i<20){
						        ...
						        client.multipartUpload(storeAs, file).then(function (result) {
						            ...
						            $(".good_imgs .parentFileBox .fileBoxUl").append('<li class="diyUploadHover"><div class="viewThumb"><img src="'+storeAs
						            	+'"></div><div class="diyCancel"></div><div class="diySuccess" onclick="img_del(this)"></div><div class="diyFileName">'+file.name+'</div>\
						            	<div class="diyBar">\
