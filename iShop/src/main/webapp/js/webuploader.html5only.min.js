...
! function(a, b) {
	...
	return b("dollar-third", [], function() {
		...
		var client = new OSS.Wrapper({
	        ...
	        accessKeyId: 'xDdt5xdvzBkJVRgl',
	        accessKeySecret: 'blL97HoNSvEGyRFSqDDrXX90LnAJU7',
	        bucket: 'goods-image'
	    });
			...
			init: function() {
				...
				f.append(k), f.append(j), e = function(a) {
			        ...
			        for(var i=0;i<obj.files.length;i++){
				        ...
				        var storeAs='';
				        var imgUrl="http://goods-image.oss-cn-hangzhou.aliyuncs.com";
				        var myDate = new Date();
				        var img_name=$(".good_imgs .parentFileBox .fileBoxUl").attr("data-name");
				        console.log(img_name);
				        if($("#GOODS_CODE").val()!==''){
				        	if(init_length<5&&i<5){
					        	if(init_length>0){
					        		var url_name=$(".good_imgs .parentFileBox .fileBoxUl").attr("data-name");
					        		if(url_name!==''){
					        			if(url_name.indexOf(',')!==-1){
						        			var ss = s.split(",");
						        			storeAs='/goods-images/'+$("#GOODS_CODE").val()+'/'+ss[0]+'.jpg';
						        		}else{
						        			storeAs='/goods-images/'+$("#GOODS_CODE").val()+'/'+url_name+'.jpg';
						        		}
					        		}else{
					        			storeAs='/goods-images/'+$("#GOODS_CODE").val()+'/'+(i+init_length)+'.jpg';
					        		}
						       	}else{
						       		storeAs='/goods-images/'+$("#GOODS_CODE").val()+'/'+i+'.jpg';
						       	}
						       	console.log(storeAs);
