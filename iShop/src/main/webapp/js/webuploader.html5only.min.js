				        ...
				        if($("#GOODS_CODE").val()!==''){
				        	if(init_length<20&&i<20){
					        	if(init_length>0){
					        		...
					        		storeAs='FAB/'+$("#OWN_CORP").val()+'/'+date+'.jpg';//路径名称，filename的正则操作是为了接受后天数据是避免逗号冲突
						       	}else{
						       		var date=new Date().getTime();
						        ...
						        client.multipartUpload(storeAs, file).then(function (result) {
						            ...
						            $(".good_imgs .parentFileBox .fileBoxUl").append('<li class="diyUploadHover"style="height: 90px"><div class="viewThumb"><img src="'+storeAs
						            	+'"></div><div class="diyCancel"></div><div class="diySuccess" onclick="img_del(this)"></div>\
						            	<div class="diyBar">\
										...
										<input style="width: 30px;margin:0px" checked="true" type="checkbox" value="" name="test" class="check public_check">\
										<label for="is_active "onclick="public_click(this)"></label>\
										</em>\
										</span>\
									</li>');
