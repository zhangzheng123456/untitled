			        ...
			        for(var i=0;i<obj.files.length;i++){
				        ...
				        if($("#GOODS_CODE").val()!==''){
				        	if(init_length<5&&i<5){
					        	if(init_length>0){
						       		storeAs='/goods-images/'+$("#GOODS_CODE").val()+'_img'+(i+init_length)+'.jpg';
						       		$(".good_imgs .parentFileBox .fileBoxUl li:nth-of-type("+(i+init_length)+") img").attr("data-src",storeAs);
						       	}else{
						       		storeAs='/goods-images/'+$("#GOODS_CODE").val()+'_img'+i+'.jpg';
						       		$(".good_imgs .parentFileBox .fileBoxUl li:nth-of-type("+i+") img").attr("data-src",storeAs);
						       	}
