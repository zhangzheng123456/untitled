        ...
        oc.postRequire("post", _command, "", _params, function (data) {
            if (data.code == "0") {
                if(_command=="/shop/add"){
                    ...
                    $(window.parent.document).find('#iframepage').attr("src", "/shop/all_shop_edit.html");
                }
...
$("#screen_que_area").click(function(){
    ...
    $(".shopadd_oper_btn ul li:nth-of-type(2)").click(function () {//点击关闭按钮跳转到列表页面
        $(window.parent.document).find('#iframepage').attr("src", "/shop/all_shop.html");
    });
