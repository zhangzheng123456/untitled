...
$("#leading_out").click(function(){
    ...
    oc.postRequire("post","/user/group/getCols","0",param,function(data){
        if(data.code=="0"){
            var message=JSON.parse(data.message);
...
$("#file_submit").click(function(){
    ...
    oc.postRequire("post","/user/group/exportExecl","0",param,function(data){
        if(data.code=="0"){
            var message=JSON.parse(data.message);
...
//筛选发送请求
function filtrates(){
   oc.postRequire("post","/user/group/screen","0",_param,function(data){
        if(data.code=="0"){
            var message=JSON.parse(data.message);
            var list=JSON.parse(message.list);
            var cout=list.pages;
