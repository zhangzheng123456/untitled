	...
	useroperatejs.bindbutton=function(){
		$(".useradd_oper_btn ul li:nth-of-type(1)").click(function(){
			if(useroperatejs.firstStep()){
				...
				var _params={"user_code":ACCOUNT,"username":USER_NAME,"avatar":HEADPORTRAIT,"phone":USER_PHONE,"email":USER_EMAIL,"sex":SEX,"corp_code":OWN_CORP,"role_code":OWN_RIGHT,"isactive":IS_ACTIVE};
