           ...
           ,scrollFun:function (e) {
                    ...
                    this.$http.post('/VipDevelop/list',{param:JSON.stringify(param)},{emulateJSON:true}).then(function (data) {
                        if(data.data.code==0){
                            if(JSON.parse(data.data.message).list.length==0){
                                ...
                                this.tableData=this.tableData.concat(JSON.parse(data.data.message).list);
                                this.loading_show=false;
                                this.data_no=false;
                            }
            ...
            ,exportFun:function (e) {
                ...
                if($(e.target).html()=='确认') {
                    ...
                    $('#mask').css('z-index',10002);
                    $('#loading').css('z-index',10002);
                    this.$http.post('/VipDevelop/exportExecl', {param: JSON.stringify(param)}, {emulateJSON: true}).then(function (data) {
