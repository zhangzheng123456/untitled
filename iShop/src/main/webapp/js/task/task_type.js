    ...
    for (var i = 0; i < data.length; i++) {
        ...
        for (var c=0;c<titleArray.length;c++){
            (function(j){
                ...
                TD+="<td data-"+code+"='"+data[i][code]+"' title='"+data[i][code]+"'><span>"+data[i][code]+"</span></td>";
            })(c)
        }
...
$("#delete").click(function(){
    ...
    var params={};
    params["id"]=ID;
    oc.postRequire("post","/task_type/delete","0",params,function(data){
        if(data.code=="0"){
            if(value==""&&filtrate==""){
               frame().then(function(){
